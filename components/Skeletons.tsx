...
export function ImageSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-2xl bg-gray-100 p-6 shadow-sm flex items-end w-[768px] h-[512px]`}
    >
...
export function ImageErrorSkeleton() {
  return (
    <div
      className={`relative overflow-hidden rounded-2xl bg-gray-100 p-6 shadow-sm flex items-end w-[768px] h-[512px]`}
    >
