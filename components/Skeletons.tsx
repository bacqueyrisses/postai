...
export function ImageSkeleton() {
  return (
    <div
      className={`${shimmer} relative overflow-hidden rounded-2xl bg-gray-100 sm:p-4 p-2 shadow-sm flex items-end w-[358px] sm:w-[768px] h-[256px] sm:h-[512px]`}
    >
...
export function ImageErrorSkeleton() {
  return (
    <div
      className={`relative overflow-hidden rounded-2xl bg-gray-100 sm:p-4 p-2 shadow-sm flex items-end w-[358px] sm:w-[768px] h-[256px] sm:h-[512px]`}
    >
